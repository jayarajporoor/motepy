...
MotePy.prototype.stmtBlock = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MotePy.IF) | (1 << MotePy.FOR) | (1 << MotePy.WHILE))) !== 0) || ((((_la - 55)) & ~0x1f) == 0 && ((1 << (_la - 55)) & ((1 << (MotePy.NEWLINE - 55)) | (1 << (MotePy.RETURN - 55)) | (1 << (MotePy.Identifier - 55)))) !== 0));
        this.state = 372;
