...
var symbolicNames = [ null, "ASYNC", "AWAIT", "AT", "DecoratorIdentifier", 
                      ...
                      "COLON", "PERIOD", "PASS", "PLUS", "MINUS", "MUL", 
...
UseSpecContext.prototype.NEWLINE = function() {
...
IncludeSpecContext.prototype.NEWLINE = function() {
    return this.getToken(MotePy.NEWLINE, 0);
};
...
ArrayLiteralContext.prototype.LS = function() {
    return this.getToken(MotePy.LS, 0);
};
...
ArrayLiteralContext.prototype.RS = function() {
    return this.getToken(MotePy.RS, 0);
};

ArrayLiteralContext.prototype.NEWLINE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
StmtContext.prototype.PASS = function() {
...
FuncDefContext.prototype.decoratorDef = function() {
    return this.getTypedRuleContext(DecoratorDefContext,0);
};
