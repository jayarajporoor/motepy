...
var literalNames = [ null, "'module'", "'->'", "'use'", "'config'", "'def'", 
                     "'const'", "'if'", "'else'", "'for'", "'in'", "'include'", 
                     "'void'", "'while'", "'true'", "'false'", "'ring'", 
                     "';'", "'('", "')'", "'{'", "'}'", "'['", "']'", "','", 
                     "'::'", "':'", "'.'", "'+'", "'-'", "'*'", "'/'", "'%'", 
                     "'**'", "'(*)'", "'(.)'", "'<'", "'>'", "'<='", "'>='", 
                     "'=='", "'!='", "'='", "'&&'", "'||'", "'!'", "'<<'", 
...
var symbolicNames = [ null, "MODULE", "ARROW", "USE", "CONFIG", "DEF", "CONST", 
                      ...
                      "BOR", "BNOT", "BXOR", "EFFECTS", "EASSIGN", "ELIF", 
                      "INT", "FLOAT", "BOOLEAN", "I8", "U8", "I16", "U16", 
                      "I32", "U32", "RETURN", "Identifier", "IntegerConstant", 
...
MotePy.prototype.arrayLiteral = function() {
    ...
    try {
        ...
        this.state = 285;
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MotePy.TRUE) | (1 << MotePy.FALSE) | (1 << MotePy.LP) | (1 << MotePy.LB) | (1 << MotePy.MINUS))) !== 0) || ((((_la - 45)) & ~0x1f) == 0 && ((1 << (_la - 45)) & ((1 << (MotePy.LNOT - 45)) | (1 << (MotePy.BAND - 45)) | (1 << (MotePy.BNOT - 45)) | (1 << (MotePy.INT - 45)) | (1 << (MotePy.FLOAT - 45)) | (1 << (MotePy.BOOLEAN - 45)) | (1 << (MotePy.I8 - 45)) | (1 << (MotePy.U8 - 45)) | (1 << (MotePy.I16 - 45)) | (1 << (MotePy.U16 - 45)) | (1 << (MotePy.I32 - 45)) | (1 << (MotePy.U32 - 45)) | (1 << (MotePy.Identifier - 45)) | (1 << (MotePy.IntegerConstant - 45)) | (1 << (MotePy.FloatingConstant - 45)) | (1 << (MotePy.CharacterConstant - 45)) | (1 << (MotePy.StringLiteral - 45)))) !== 0)) {
            this.state = 277;
            this.expr(0);
            this.state = 282;
            this._errHandler.sync(this);
...
VarDefContext.prototype.COLON = function() {
    return this.getToken(MotePy.COLON, 0);
};
...
VarDefContext.prototype.SEMI = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
MotePy.prototype.stmtBlock = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MotePy.IF) | (1 << MotePy.FOR) | (1 << MotePy.WHILE))) !== 0) || ((((_la - 64)) & ~0x1f) == 0 && ((1 << (_la - 64)) & ((1 << (MotePy.RETURN - 64)) | (1 << (MotePy.Identifier - 64)) | (1 << (MotePy.NEWLINE - 64)))) !== 0));
        this.state = 374;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 3:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 48)) & ~0x1f) == 0 && ((1 << (_la - 48)) & ((1 << (MotePy.BAND - 48)) | (1 << (MotePy.BOR - 48)) | (1 << (MotePy.BXOR - 48)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                        this.consume();
                ...
                case 5:
                    ...
                    localctx.op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if(!(((((_la - 30)) & ~0x1f) == 0 && ((1 << (_la - 30)) & ((1 << (MotePy.MUL - 30)) | (1 << (MotePy.DIV - 30)) | (1 << (MotePy.MOD - 30)) | (1 << (MotePy.HPROD - 30)))) !== 0))) {
                        localctx.op = this._errHandler.recoverInline(this);
                    }
                    else {
                        this.consume();
...
MotePy.prototype.relExpr = function() {
    ...
    try {
        ...
        case 1:
            ...
            localctx.op = this._input.LT(1);
            _la = this._input.LA(1);
            if(!(((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (MotePy.LT - 36)) | (1 << (MotePy.GT - 36)) | (1 << (MotePy.LTE - 36)) | (1 << (MotePy.GTE - 36)) | (1 << (MotePy.EQ - 36)) | (1 << (MotePy.NEQ - 36)))) !== 0))) {
                localctx.op = this._errHandler.recoverInline(this);
            }
            else {
                this.consume();
